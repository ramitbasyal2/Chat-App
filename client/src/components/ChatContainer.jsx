...
const ChatContainer = () => {
 ...
 useEffect(()=>{
  ...
  useEffect(()=>{
   if(scrollEnd.current && messages){
    ...
    return selectedUser ? (
    <div className='h-full overflow-scroll ralative backdrop-blur-lg'>
        {/* ==================== header ====================== */}
 ...
 {/* -------------------------------- bottom area ------------------------------------- */}
    ...
    <div className='w-full h-screen flex flex-col items-center justify-center gap-2 text-gray-500
