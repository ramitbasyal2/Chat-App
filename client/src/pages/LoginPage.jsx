...
const {login} = useContext(AuthContext)
 ...
 //function for real login signup using context
 const payload =
 ...
 login(currentState === "Sign Up" ? "signup" : "login", payload)
  ...
  {/* ----------- left -------------- */}
   ...
   <form onSubmit={onSubmitHandler} className='border-2 bg-white/0 text-white border-gray-500 p-6 flex
  ...
  {currentState === 'Sign Up' && !isDataSubmitted && (
    ...
    className='p-2 border border-gray-500 ronded-md 
  ...
  <div className='flex flex-col gap-2'>
       {currentState === 'Sign Up' ? (
        <p className='text-sm text-gray-500'>Already have an Account? <span className=
        'cursor-pointer border-b border-gray-500 text-gray-400' 
       ...
       : (
         ...
         <span className='cursor-pointer border-b border-gray-500 text-gray-400' 
